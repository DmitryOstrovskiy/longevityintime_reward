...
class Wallet(models.Model):
    ...
    wallet_address = models.CharField(max_length=254, blank=True, null=True, verbose_name='Wallet Address')
...
class TestCard(models.Model):
    name = models.TextField(blank=False, null=False, verbose_name='Name of the analysis')
    parameter = models.TextField(blank=False, null=False, verbose_name='Name of the parameter')
    parameter_value = models.TextField(blank=False, null=False, verbose_name='Parameter value')
    pub_date = models.DateTimeField(auto_now_add=True)
    author = models.ForeignKey(User, on_delete=models.CASCADE, related_name='testcards')
